...
async function peopleVisitUpdate(req, res) {
  ...
  // attrs is required if we have a personId
  if (req.body.personId && typeof req.body.attrs !== 'object') return _400(res, "Invalid value to parameter 'attrs'.");
...
async function peopleVisitRemove(req, res) {
  return _400(res, "Not Implemented yet.");
}
...
export function doExpressStartup() {
  ...
  app.post(base_uri+'/people/visit/remove', peopleVisitRemove);
