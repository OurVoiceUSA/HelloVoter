...
export async function doStartupTasks() {
...
async function doDbInit() {
  ...
  let defaultAttributes = [
    ...
    {id: "4a320f76-ef7b-4d73-ae2a-8f4ccf5de344", name: "Party Affiliation", order: 1, type: "string", multi: false, values: ["No Party Preference","Democratic","Republican","Green","Libertarian"]},
    {id: "dcfc1fbb-4609-4900-bbb3-1c4afb2a5127", name: "Registered to Vote", order: 2, type: "boolean", multi: false},
    {id: "432634fd-dc28-457d-ae1f-d6fa8d242d30", name: "Subscribe to Carpool Vote", order: 3, type: "boolean", multi: false},
  ...
  await asyncForEach(defaultAttributes, async (attribute) => {
    ...
    if (ref.data[0] === 0) {
      await cqa('create (:Attribute {id:{id},name:{name},order:{order},type:{type},multi:{multi}})', attribute);
...
async function postDbInit() {
  ...
  await clearQueue("Task was active upon server startup and thus marked as failed.");
